# Generated by Django 3.1.3 on 2023-05-13 06:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('choice_set', models.BooleanField(choices=[(True, True), (False, False)], default=False)),
        ...
        migrations.AddField(
            model_name='choice',
            name='choice_text',
            field=models.ManyToManyField(related_name='choice_model', to='onlinecourse.Question'),
        ),
        migrations.AddField(
            model_name='choice',
            name='question_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='question_model', to='onlinecourse.question'),
        ),
    ]
